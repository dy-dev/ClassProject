...
#include "ClassProject/Public/MyObject.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	CLASSPROJECT_API UClass* Z_Construct_UClass_UMyObject_NoRegister();
	CLASSPROJECT_API UClass* Z_Construct_UClass_UMyObject();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMyObject_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMyObject_MyFunction, "MyFunction" }, // 2711693468
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMyObject_Statics::NewProp_Myfloat = { "Myfloat", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMyObject, Myfloat), METADATA_PARAMS(Z_Construct_UClass_UMyObject_Statics::NewProp_Myfloat_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMyObject_Statics::NewProp_Myfloat_MetaData)) };
	...
	IMPLEMENT_CLASS(UMyObject, 2409874306);
	template<> CLASSPROJECT_API UClass* StaticClass<UMyObject>()
	{
		return UMyObject::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMyObject(Z_Construct_UClass_UMyObject, &UMyObject::StaticClass, TEXT("/Script/ClassProject"), TEXT("UMyObject"), false, nullptr, nullptr, nullptr);
