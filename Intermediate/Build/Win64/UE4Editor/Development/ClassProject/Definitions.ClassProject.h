...
#define UE_PROJECT_NAME ClassProject
#define UE_TARGET_NAME ClassProjectEditor
#define UE_MODULE_NAME "ClassProject"
...
#define CLASSPROJECT_API DLLEXPORT
